...
<nav class="nav-wraper indigo">
 <a href="#!" class="brand-logo center"> Register Dog </a>
</nav>
  ...
  <div class="row">
   ...
   <div>
     <p> Can Dog be off leash?
       <span><label>&nbsp;&nbsp;
              <input type="checkbox"  id="offLeash" name="offLeash" ${dog.offLeash =='1' ? 'checked' : ''}/>
     ...
     <p> Is Dog allow to go in Water?
       <span><label>&nbsp;&nbsp;
              <input type="checkbox" name="waterOk" ${dog.waterOk =='1' ? 'checked' : ''}/>
              <span class="right-align">&nbsp </span>
              </label>
         </span></P>
     </div>    
     ...
     <p>Needs a walk to business?
       <span><label>&nbsp;&nbsp;
              <input type="checkbox" name="walk" ${dog.walk =='1' ? 'checked' : ''}/>
              <span class="right-align">&nbsp</span>
              </label>
         </span></P>
     </div>   
    <div>
     <p> Can Dog have Treats?
       <span><label>&nbsp;&nbsp;
              <input type="checkbox" name="treats"${dog.treats =='1' ? 'checked' : ''}/>
              <span class="right-align">&nbsp</span>
              </label>
          </span></P>
       
         <p> How many times per Day?
           <input type="number" id="times" name="perDay" max="6">${dog.perDay == 0 ? '' : dog.perDay}</>
         </P>
   </div>   
	...
	<div class="col l4 s12 left-align">
     ...
     <div class="col l4 s12 right-align">
  	...
  	<div class="col l6 s12">
    	<div class="input-field" >
     		<select name="sleepingPreference" >
     	      <option class="small-text left" value="" ${sleepingPreference=='' ? 'selected' : ''}>-- Choose --</option>
	   	      <option class="small-text left" value="On floor" ${sleepingPreference=='On floor' ? 'selected' : ''}>On floor</option>
     	      <option class="small-text left" value="Couches" ${sleepingPreference=='Couches' ? 'selected' : ''}>Couches</option>
     	      <option class="small-text left" value="Crate" ${sleepingPreference=='Crate' ? 'selected' : ''}>Crate</option>
     	      <option class="small-text left" value="Bed" ${sleepinPpreference=='Bed' ? 'selected' : ''}>Bed</option>
             </select>
              <!--  <label>Food Type</label> -->
    ...
    <div  class="input-field right">
      <c:choose>
           ...
           <c:when test='${mode == "ADD"}'>
            ...
            <input type="submit" name="update" value="Update" class="btn indigo"/> 
            </c:when>
            <c:otherwise> <input type="submit" name="submit" value="Submit " class="btn indigo"/> 
             </c:otherwise>
     </c:choose>
    </div>
 </form>
